        ...
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-2">
            ...
            <p className="text-muted-foreground leading-relaxed max-w-md">
              The future of AI interaction. Connect with intelligent characters, 
              share meaningful conversations, and explore new forms of digital companionship.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              <li><a href="#" className="hover:text-primary transition-colors">Characters</a></li>
