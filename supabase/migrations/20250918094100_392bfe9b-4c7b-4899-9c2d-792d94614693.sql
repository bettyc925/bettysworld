...
-- Fix 2: Create a system user for orphaned characters
-- Insert a system profile first
...
-- Update characters with null created_by values to use system user
UPDATE public.characters 
SET created_by = '00000000-0000-0000-0000-000000000000'
WHERE created_by IS NULL;

-- Fix 3: Make created_by NOT NULL to prevent future issues
ALTER TABLE public.characters 
ALTER COLUMN created_by SET NOT NULL;

-- Fix 4: Add validation trigger for character creation
...
-- Fix 5: Add validation for profile updates
