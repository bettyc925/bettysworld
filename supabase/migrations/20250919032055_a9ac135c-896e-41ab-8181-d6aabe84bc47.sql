-- Make created_by nullable for demo characters and add sample data
-- First, temporarily allow NULL values for created_by
ALTER TABLE public.characters ALTER COLUMN created_by DROP NOT NULL;

-- Add a demo_character flag to distinguish between real and demo characters
...
-- Update RLS policies to handle demo characters
